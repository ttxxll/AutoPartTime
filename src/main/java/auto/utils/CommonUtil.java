...
public class CommonUtil {
    ...
    /**
     * 如果短链码重复，则调用该方法，增加版本号，url前缀+1
     * 保证C端和B端发生重复时，新版本的短链码仍然一致
     * @param url
     * @return
     */
    public static String addUrlPrefixVersion(String url) {
        ...
        return Long.parseLong(version) + 1 + "&" + originalUrl;
    }
     ...
     * @param response
     */
    public static void sendHtmlMessage(HttpServletResponse response, BaseResult jsonData) {
